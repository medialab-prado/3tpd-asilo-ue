...
absolutes <- ggplot() +
  geom_bar(data=europe_grouped, aes(y = value, x = year, fill = decision_fin), stat="identity") +
  ...
  ggtitle("Absolutes") +
  geom_text(data=europe_grouped, aes(x=year, y=value * 0.8, label=value), size=3) +
  coord_flip() +
  theme_bw() + 
  theme(legend.position="none") + 
  facet_grid( destiny_europe ~ decision_fin)
...
rel_year <- ggplot() +
  geom_bar(data=europe_grouped_per, aes(y = per, x = year, fill = decision_fin), stat="identity") +
  scale_fill_manual(values = c("#00BEC4", "#F8766D")) + 
  ...
  geom_text(data=europe_grouped_per, aes(x=year, y=per * 0.8, label=round(per, 2)), size=3) +
  coord_flip() +
  theme_bw() + 
  theme(legend.position="none") + 
  facet_grid(destiny_europe ~ decision_fin)
...
absolutes <- ggplot() +
  geom_bar(data=ue_grouped, aes(y = value, x = year, fill = decision_fin), stat="identity") +
  scale_fill_manual(values = c("#00BEC4", "#F8766D")) + 
  scale_y_continuous(name="absolutes") + 
  ggtitle("Absolutes") +
  scale_x_discrete(limits=unique(ue_grouped$year)) +
  geom_text(data=ue_grouped, aes(x=year, y=value * 0.8, label=value), size=3) +
  coord_flip() +
  theme_bw() + 
  theme(legend.position="none") +
  facet_grid( origin_continent ~ decision_fin)
...
rel_year <- ggplot() +
  geom_bar(data = na.omit(ue_grouped_per), aes(y = per, x = year, fill = decision_fin), stat="identity") +
  scale_fill_manual(values = c("#00BEC4", "#F8766D")) + 
  scale_y_continuous(name="relatives per year") + 
  ggtitle("Relatives per year") +
...
absolutes <- ggplot() +
  geom_bar(data=country_grouped, aes(y = value, x = year, fill = decision_fin), stat="identity") +
  scale_fill_manual(values = c("#00BEC4", "#F8766D")) + 
  scale_y_continuous(name="Absolutes") + 
  ggtitle("Absolutes") +
  scale_x_discrete(limits=unique(country_grouped$year)) +
  geom_text(data=country_grouped, aes(x=year, y=value, label=value), size=3) +
  coord_flip() +
  theme_bw() + 
  theme(legend.position="none") + 
  facet_grid(origin_label_f ~ decision_fin)
...
rel_year <- ggplot() +
  geom_bar(data = na.omit(country_grouped_per), aes(y = per, x = year, fill = decision_fin), stat="identity") +
  scale_fill_manual(values = c("#00BEC4", "#F8766D")) + 
  scale_y_continuous(name="relatives per year") + 
  ggtitle("Relatives per year") +
  ...
  theme_bw() + 
  theme(legend.position="none") + 
  facet_grid( origin_label ~ decision_fin)
